...
export default function Home(): ReactNode {
  ...
  return (
    <Layout
      ...
      description="Documentação completa da Unidade Lógica e Aritmética de 8 bits construída no simulador Digital"
    >
      {/* Hero */}
      <section className="hero-alu">
        <div className="section-chip">⚡ Circuitos Digitais — Módulo 5 · Inteli</div>
        <h1 className="hero-alu__title">ALU 8-bit</h1>
        <p className="hero-alu__subtitle">
          Unidade Lógica e Aritmética de 8 bits construída do zero no simulador Digital.
          Documentação completa de todas as 7 operações — da teoria ao circuito.
        </p>
      ...
      <div className="stats-row">
        ...
        <div className="stat-item">
          ...
          <div className="stat-label">módulos .dig</div>
        </div>
      </div>
      ...
      <main>
        <div style={{ textAlign: 'center', padding: '2.5rem 1rem 0' }}>
          <h2 style={{ fontSize: '1.8rem', fontWeight: 700 }}>Operações Implementadas</h2>
